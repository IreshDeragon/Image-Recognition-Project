...
class PMC {
    ...
    double *predictReg(double *entry);
    double calculTotalPredictReg(int layer, int nbInput, int output, double *input);
    void trainReg(int epochs, double LR, double **points, double **Y, int pointsSize);
    void train(int epoch, double LR, double** points, double** Y, int pointsSize);
